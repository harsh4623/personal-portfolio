        ...
        return (
            ...
            <motion.div
                ...
                <motion.div className="textContainer" variants={variants}>
                    ...
                    <motion.div className="item" variants={variants}>
                        <h2> Email Id</h2>
                        <span>harshpatel46399@gmail.com</span>
                    </motion.div>
                    <motion.div className="item" variants={variants}>
                        <h2> Phone</h2>
                        <span>+91 82005 76528</span>
                    </motion.div>
                    ...
                    >
                        ...
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
                            <motion.path
                                ...
                                d="M13.5 2C13.5 2 15.8335 2.21213 18.8033 5.18198C21.7731 8.15183 21.9853 10.4853 21.9853 10.4853" stroke="#ff2600" stroke-width="1.5" stroke-linecap="round"></motion.path>
                            <motion.path
                                ...
                                transition={{ duration: 2 }}
                                d="M14.207 5.53564C14.207 5.53564 15.197 5.81849 16.6819 7.30341C18.1668 8.78834 18.4497 9.77829 18.4497 9.77829" stroke="#ff2600" stroke-width="1.5" stroke-linecap="round"></motion.path>
                            <motion.path
                                strokeWidth={0.2}
                                fill="none"
                                initial={{ pathLength: 0 }}
